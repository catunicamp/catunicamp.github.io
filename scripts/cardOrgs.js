...
let orgsList = [
    ...
    },   
    {
        ...
        university: `FT | FCA`,
        image: `integra.jpeg`,
        about: `A Integra é uma Empresa Júnior especializada na prestação de serviços de consultoria nas áreas de Engenharia e Administração. Fundada e gerida por alunos de graduação da UNICAMP, nossa trajetória no mercado deu início no ano de 2009. Ao longo desse percurso, já realizamos mais de 170 projetos de consultoria, atendendo a uma ampla variedade de clientes, com objetivos, modelos de negócio e perfis diferentes. 
        <br><br>
        Nossa dedicação ao trabalho como empresários juniores é pautada na convicção de que nossos projetos têm o potencial de gerar um impacto positivo na sociedade que nos cerca. Além disso, compartilhamos um propósito comum: promover o crescimento não apenas profissional, como também pessoal e acadêmico, visando a formação de lideranças comprometidas e capazes.`,
    ...
    },
    {
        ...
        linkedin: `https://www.linkedin.com/company/unicamp-racing-team-1600/`,
        instagram: `https://www.instagram.com/unicamp1600`,
        disabled: false,
        fca:true,
        ft:true,
    },
    ...
    {
        title: `LACA - Liga Acadêmica de Comportamento Alimentar da UNICAMP`,
        type: OrgType.liga,
        image: `laca.jpeg`,
        about: `A LACA UNICAMP tem como objetivo aprofundar conhecimentos sobre o comportamento alimentar, de forma que os alunos desenvolvam um olhar mais empático, crítico e consciente sobre o tema. Buscamos compreender além do que comemos, mas também por que, onde, com quem, quando e o que sentimos quando comemos.`,
        email: `mailto:lacaunicamp@gmail.com`,
        instagram: `https://www.instagram.com/laca.unicamp`,
        whatsapp: `https://wa.me/+5519794237078`,
        disabled: false,
        fca:true,
        ft:false,
    },
    {
        ...
        type: OrgType.ej,
        image: `eixo.jpeg`,
        about: `Fundada em 2016, pelos alunos de Administração Pública da FCA, a Eixo Público - Consultoria Júnior atua no campo de públicas, oferecendo consultoria à órgãos ligados ao segundo setor, à gestão pública ou que prestem algum serviço para essa área. Oferecemos serviços de consultoria em gestão de finanças, gestão de processos, gestão de pessoas, marketing e pesquisa de mercado, além de treinamentos e capacitações nos mais diversos tópicos da administração pública`,
        facebook: `https://www.facebook.com/EIXOPUBLICO`,
        email: `mailto:comercial@eixopublico.com`,
